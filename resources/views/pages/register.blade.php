...
<head>
    ...
    <title>Registration - CleanCo</title>
            ...
            <div class="col-md-6 bg-form">
                <div class="form-container">
                    ...
                    <form action="{{ route('register.submit') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <input type="text" name="address" class="form-control custom-input @error('address') is-invalid @enderror"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="custom-radio-group @error('gender') is-invalid @enderror">
                        ...
                        <div class="mb-3">
                            <input type="text" name="telephone" class="form-control custom-input @error('telephone') is-invalid @enderror"
                                placeholder="No. Telp" value="{{ old('telephone') }}">
                            @error('telephone')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="text-center mt-3">  
                            ...
                            <a href="{{ route('login') }}" class="text-decoration-none fw-bold" style="color: #0d6efd;">Log in</a>
                        </div>
                    </form>
