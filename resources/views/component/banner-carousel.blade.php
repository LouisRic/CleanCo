                    ...
                    <div class="promo-content">
                        <div class="promo-circle">
                            <div class="promo-circle-inner">
                                <span class="promo-big-text">BIG<br>SALE</span>
                            </div>
                        </div>
                        ...
                        <div class="promo-discount-badge">
                            <span class="discount-text-top">UP TO</span>
            ...
            <div class="carousel-item">
                <div class="promo-banner promo-banner-yellow">
                    ...
                    <div class="promo-content">
                        <div class="promo-circle">
                            <div class="promo-circle-inner">
                                <span class="promo-big-text">NEW<br>USER</span>
                            </div>
                        </div>
                        <div class="promo-ribbon">
                            First Order
            ...
            <div class="carousel-item">
                <div class="promo-banner promo-banner-yellow">
                    ...
                    <div class="promo-content">
                        <div class="promo-circle">
                            <div class="promo-circle-inner">
                                <span class="promo-big-text">WEEK<br>END</span>
                            </div>
                        </div>
                        <div class="promo-ribbon">
                            Saturday & Sunday
