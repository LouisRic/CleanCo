...
@section('content')
    ...
    <div class="row g-4 justify-content-center mb-4">
        <div class="col-md-6">
            <a href="{{ route('transactions.create') }}" class="btn btn-success w-100 py-3 fw-bold fs-5">
                {{ __('admin_dashboard.add_transaction') }}
            </a>
        </div>

        <div class="col-md-6">
            <a href="{{ route('services.create') }}" class="btn btn-primary w-100 py-3 fw-bold fs-5">
            ...
            <div class="card shadow-sm border-1 rounded-3 bg-white">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('customers.index') }}"
                        class="btn btn-primary btn-sm">{{ __('admin_dashboard.more_info') }}</a>
                </div>
            </div>
        </div>
